...
public class Board {
    ...
    // private Map<Piece, Position> positionOfPieces = new Hashmap<Piece,
    // Position>();
    ...
    // positions[4].addNeighbors({positions[3], positions[1], positions[5],
    // positions[4]});
    ...
    // positions[10].addNeighbors({positions[3], positions[9], positions[11],
    // positions[18]});
    ...
    // positions[13].addNeighbors({positions[5], positions[14], positions[12],
    // positions[20]});
    ...
    // positions[19].addNeighbors({positions[16], positions[18], positions[20],
    // positions[22]});
